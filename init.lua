...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sf', builtin.git_files, { desc = '[S]earch [F]iles in Git Repository' })
      vim.keymap.set('n', '<leader>sa', builtin.find_files, { desc = '[S]earch Through [A]ll Files' })
